...
<%
        ...
        sql = " SELECT * FROM Telefonos WHERE apellidos Like 'm%' "
...
%>
  ...
  <center><table width="86%" border="0" height="18">
	...
	&nbsp;</font></strong></td>
     ...
     <a href="actualizartel.asp?idcontacto=<%=rs("apellidos")%>"><b>
     ...
     <td bgcolor = #FFFF99 width="6%" height="14"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
      ...
      <a href="eliminar.asp?borrar=true&idcontacto=<%=rs("apellidos")%>"><font size="1" face="Verdana, Arial, Helvetica, sans-serif" style="text-decoration:yes"><b>Eliminar</b></font></a></font></td>
    </tr>
</font></td>
